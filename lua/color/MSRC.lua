...
local varioFilter = { "Filter", nil, 1, 3, 1, 0x5126 }
...
function drawPage()
    ...
    elseif status == "config" then
        ...
        elseif page == 4 then
            ...
            lcd.drawText(200, 50, vars[page][3][2], SMLSIZE + getTextFlags(3))
            lcd.drawText(1, 65, vars[page][4][1], SMLSIZE)
            lcd.drawText(200, 65, getValue(escProtocolStr, vars[page][4][2] + 1), SMLSIZE + getTextFlags(4))
            ...
            elseif escProtocolStr[vars[page][4][2] + 1] == "Smart ESC/BAT" then
                ...
                lcd.drawText(1, 80, vars[page][5][1], SMLSIZE)
                lcd.drawText(200, 80, getValue(onOffStr, vars[page][5][2] + 1), SMLSIZE + getTextFlags(5))
            else
        ...
        elseif page == 5 then
            lcd.drawText(1, 20, vars[page][1][1], SMLSIZE)
            lcd.drawText(200, 20, getValue(onOffStr, vars[page][1][2] + 1), SMLSIZE + getTextFlags(1))
            lcd.drawText(1, 35, vars[page][2][1], SMLSIZE)
            lcd.drawText(200, 35, getValue(gpsProtocolStr, vars[page][2][2] + 1), SMLSIZE + getTextFlags(2))
            lcd.drawText(1, 50, vars[page][3][1], SMLSIZE)
            lcd.drawText(200, 50, getValue(gpsBaudrateVal, vars[page][3][2] + 1), SMLSIZE + getTextFlags(3))
            lcd.drawText(1, 65, vars[page][4][1], SMLSIZE)
            lcd.drawText(200, 65, getValue(gpsRateVal, vars[page][4][2] + 1), SMLSIZE + getTextFlags(4))
        -- 6 Vario
        elseif page == 6 then
            lcd.drawText(1, 20, vars[page][1][1], SMLSIZE)
            lcd.drawText(200, 20, getValue(varioModelStr, vars[page][1][2] + 1), SMLSIZE + getTextFlags(1))
            lcd.drawText(1, 35, vars[page][2][1], SMLSIZE)
            lcd.drawText(200, 35, vars[page][2][2], SMLSIZE + getTextFlags(2))
            if varioModelStr[vars[page][1][2] + 1] == "BMP280" then
                vars[page] = { varioModel, varioAddress, varioFilter }
                lcd.drawText(1, 50, vars[page][3][1], SMLSIZE)
                lcd.drawText(200, 50, getValue(varioFilterStr, vars[page][3][2]), SMLSIZE + getTextFlags(3))
            else
        ...
        elseif page == 8 then
            ...
            lcd.drawText(200, 20, vars[page][1][2], SMLSIZE + getTextFlags(1))
            lcd.drawText(1, 35, vars[page][2][1], SMLSIZE)
            lcd.drawText(200, 35, getValue(onOffStr, vars[page][2][2] + 1), SMLSIZE + getTextFlags(2))
            lcd.drawText(1, 50, vars[page][3][1], SMLSIZE)
            lcd.drawText(200, 50, getValue(onOffStr, vars[page][3][2] + 1), SMLSIZE + getTextFlags(3))
            lcd.drawText(1, 65, vars[page][4][1], SMLSIZE)
            lcd.drawText(200, 65, getValue(onOffStr, vars[page][4][2] + 1), SMLSIZE + getTextFlags(4))
            lcd.drawText(1, 80, vars[page][5][1], SMLSIZE)
            lcd.drawText(200, 80, getValue(onOffStr, vars[page][5][2] + 1), SMLSIZE + getTextFlags(5))
            lcd.drawText(1, 95, vars[page][6][1], SMLSIZE)
            lcd.drawText(200, 95, getValue(onOffStr, vars[page][6][2] + 1), SMLSIZE + getTextFlags(6))
            lcd.drawText(1, 110, vars[page][7][1], SMLSIZE)
            lcd.drawText(200, 110, getValue(onOffStr, vars[page][7][2] + 1), SMLSIZE + getTextFlags(7))
        -- 9 Analog rate
        elseif page == 9 then
            lcd.drawText(1, 20, vars[page][1][1], SMLSIZE)
            lcd.drawText(200, 20, vars[page][1][2], SMLSIZE + getTextFlags(1))
        ...
        elseif page == 12 then
            ...
            lcd.drawText(200, 20, getValue(onOffStr, vars[page][1][2] + 1), SMLSIZE + getTextFlags(1))
            lcd.drawText(1, 35, vars[page][2][1], SMLSIZE)
            lcd.drawText(200, 35, getValue(analogCurrTypeStr, vars[page][2][2] + 1), SMLSIZE + getTextFlags(2))
            if analogCurrTypeStr[vars[page][2][2] + 1] == "Hall Effect" then
                ...
                if getValue(onOffStr, vars[page][4][2] + 1) == "On" then
                    lcd.drawText(1, 50, vars[page][3][1], SMLSIZE)
                    lcd.drawText(200, 50, vars[page][3][2], SMLSIZE + getTextFlags(3))
                    lcd.drawText(1, 65, vars[page][4][1], SMLSIZE)
                    lcd.drawText(200, 65, getValue(onOffStr, vars[page][4][2] + 1), SMLSIZE + getTextFlags(4))
