...
class MainWindow : public QMainWindow {
   ...
   private slots:
    ...
    void showAbout();
    void exitApp();
    void on_cbReceiver_currentIndexChanged(int index);
    void on_cbEsc_currentIndexChanged(int index);
    ...
    void on_cbBarometerType_currentIndexChanged(int index);
    void on_btCircuit_clicked();
    void on_gbGps_toggled(bool arg1);
    void on_cbCurrentAutoOffset_toggled(bool checked);
    void on_cbCurrentSensorType_currentIndexChanged(int index);
