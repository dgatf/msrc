...
typedef enum gps_dynmodel_t : uint8_t { GPS_DYNMODEL_PORTABLE = 0, GPS_DYNMODEL_STATIONARY = 2, GPS_DYNMODEL_PEDESTRIAN = 3, GPS_DYNMODEL_AUTOMOTIVE = 4, GPS_DYNMODEL_SEA = 5, GPS_DYNMODEL_AIRBORNE1 = 6, GPS_DYNMODEL_AIRBORNE2 = 7, GPS_DYNMODEL_AIRBORNE4 = 8 } gps_dynmodel_t;
...
typedef enum gps_dynmodel_t { GPS_DYNMODEL_PORTABLE = 0, GPS_DYNMODEL_STATIONARY = 2, GPS_DYNMODEL_PEDESTRIAN = 3, GPS_DYNMODEL_AUTOMOTIVE = 4, GPS_DYNMODEL_SEA = 5, GPS_DYNMODEL_AIRBORNE1 = 6, GPS_DYNMODEL_AIRBORNE2 = 7, GPS_DYNMODEL_AIRBORNE4 = 8 } gps_dynmodel_t;
