...
// Select sensors
#define CONFIG_ESC_PROTOCOL PROTOCOL_KONTRONIK // PROTOCOL_NONE PROTOCOL_KONTRONIK PROTOCOL_HW_V3, PROTOCOL_HW_V4_LV, PROTOCOL_HW_V4_HV, PROTOCOL_HW_V5_LV, PROTOCOL_HW_V5_HV, PROTOCOL_PWM, PROTOCOL_CASTLE
