...
/* Sensors */
#define CONFIG_ESC_PROTOCOL PROTOCOL_HW_V4 // PROTOCOL_NONE, PROTOCOL_HW_V3, PROTOCOL_HW_V4, PROTOCOL_PWM, PROTOCOL_CASTLE, PROTOCOL_KONTRONIK, PROTOCOL_APD_F, PROTOCOL_APD_HV
