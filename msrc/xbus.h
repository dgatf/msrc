...
protected:
...
#endif
#if CONFIG_VOLTAGE2
    Voltage volt2 = Voltage(PIN_VOLTAGE2, ALPHA(CONFIG_AVERAGING_ELEMENTS_VOLT));
#endif
#if CONFIG_NTC2
    ...
    EscHW4 esc = EscHW4(ESC_SERIAL, ALPHA(CONFIG_AVERAGING_ELEMENTS_RPM), ALPHA(CONFIG_AVERAGING_ELEMENTS_VOLT), ALPHA(CONFIG_AVERAGING_ELEMENTS_CURR), ALPHA(CONFIG_AVERAGING_ELEMENTS_TEMP), CONFIG_ESC_PROTOCOL - PROTOCOL_HW_V4_LV);
#endif
